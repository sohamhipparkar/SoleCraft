                  ...
                  {recentActivity.map((activity, index) => (
                    ...
                    >
                      <div className="flex items-center space-x-4 flex-1">
                        <div
                          className={`p-2.5 bg-${activity.color}-500/20 rounded-lg border border-${activity.color}-500/30`}
                        >
                          {activity.icon}
                        </div>
                        <div className="flex-1">
                  ...
                  {upcomingAppointments.map((appointment, index) => (
                    ...
                    >
                      <div className="flex items-start justify-between">
                        ...
                        <div
                          className={`p-2 ${appointment.type === "consultation" ? "bg-blue-500/20" : "bg-purple-500/20"} rounded-lg`}
                        >
                ...
                <div className="flex items-start justify-between mb-4">
                  <div>
                    ...
                    <p className="text-gray-800 max-w-md leading-relaxed">
                      Schedule a custom design consultation this week and
                      receive 20% off your next repair service.
                    </p>
                  </div>
